          ...
          switch ($this_column_type) {
            ...
            case 'wigt-btn-gen':
              ...
              $this_widget_btn = $renderredPopUp."<br>
                <div class='wdt-$this_column_type parent-btn-$randomBtnClass' style='text-align:$btnAllignment;'><a href='$btnLink' style='text-decoration:none !important;' target='$btnBlankAttr' id='btnLink-$randomBtnClass' ".$this_widget_btn_content['btnCAction']." > <button class='btn-$randomBtnClass' $thisBtnStyles >$btnIconBefore $btnText  $btnIconAfter</button></a></div> $this_btn_click_detectionScript 
                ";
              ...
              case 'wigt-pb-navmenu':
                ...
                if(1 === preg_match('~[0-9]~', $thisSelectedFont)){
                 ...
                 $customStyles = "<style>  ".
                  ...
                  "#".$pbCustomId." ul li a { text-decoration:none; color:".$allNavStyles['cnsfc']."; font-size:".$allNavStyles['cnsfs']."px; font-family: ". str_replace('+', ' ', $thisSelectedFont ) ." , Sans-Serif ;  padding:".$allNavStyles['cnslh']."px 8px; background:".$allNavStyles['cnsbc'].";  border-radius:2px;  display:block; } ".
