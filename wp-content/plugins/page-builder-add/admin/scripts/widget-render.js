...
function pricingWidgetRender(this_widget_pricing, j, rowID, this_column_type,this_column){
  ...
  var headerContentWrapped =  pricingHeaderEditingSaveTriggerBtn +" <div class='wltControls' style='display:none;'></div> <div class='liveTextWrap liveText-"+j+" ' data-colInd='"+this_column+"' data-rowId='"+rowID+"'> <span contenteditable='true' class='eltEditable' >  " +pbPricingHeaderText+ ' </span> </div> ';
    ...
    pricingHeader = '';
              ...
              var this_widget_btn_complete = "<br><div class='wdt-"+'pricingButton'+" parent-"+pbWidgetBtnId+"' style='text-align:"+btnButtonAlignment+";'> <button id='"+pbWidgetBtnId+"' style='color:"+btnTextColor+" !important;font-size:"+btnFontSize+"px !important; background: "+btnBgColor+" !important; background-color: "+btnBgColor+" !important;  border: "+btnBorderWidth+"px solid "+btnBorderColor+" !important; border-radius: "+btnBorderRadius+"px !important; font-family:"+btnButtonFontFamily+" ,sans-serif; "+btn_width+" ' disabled >   "+btnTextWrapped+"  </button></div> <style> #"+pbWidgetBtnId+":hover {background:"+btnHoverBgColor+" !important; color:"+btnHoverTextColor+" !important; transition: all .5s;}  </style>";
  ...
  //var t0 = performance.now();
          ...
          switch (this_column_type) {
            ...
            case 'wigt-btn-gen':
              ...
              var this_widget_btn_complete = "<br><div class='wdt-"+this_column_type+" parent-"+pbWidgetBtnId+"' style='text-align:"+btnButtonAlignment+";'> <button id='"+pbWidgetBtnId+"' style='color:"+btnTextColor+" !important;font-size:"+btnFontSize+"px !important; background: "+btnBgColor+" !important; background-color: "+btnBgColor+" !important;  border: "+btnBorderWidth+"px solid "+btnBorderColor+" !important; border-radius: "+btnBorderRadius+"px !important; font-family:"+btnButtonFontFamily+" ,sans-serif; "+btn_width+" ' disabled >   "+btnTextWrapped+"  </button></div> <style> #"+pbWidgetBtnId+":hover {background:"+btnHoverBgColor+" !important; color:"+btnHoverTextColor+" !important; transition: all .5s;}  </style>";
