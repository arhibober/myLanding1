...
<div style='width:95%;margin-left:2.5%; text-align:center; background:#e3e3e3;height:60px;border-left:5px solid #a7d142;margin-top:0;'>
 ...
 <a href="https://pluginops.com/page-builder/?ref=ulp" id='pr_msg_link' style='float:left; font-size:20px; margin:20px 0 0 10px;'><i>Get more Amazing Features and Templates Click Here</i></a>
</div>
